	...
	<div class="<?= $boligHero; ?>">
		...
		<?php if(have_rows( 'gallery' ) ) : ?>
            ...
            while (have_rows('gallery')) : the_row(); $count++;
                ...
                if(in_array($status, ['SOLD', 'RESERVED']) && $count > 1){
                    continue;
                }
            ...
            if($floorplans && !in_array($status, ['SOLD', 'RESERVED'])){
		...
		<?php if ($floorplans && !in_array($status, ['SOLD', 'RESERVED'])) : ?>
		...
		<?php if($video && !in_array($status, ['SOLD', 'RESERVED'])): ?>
				...
				<div class="col-12">
					<div class="bigHeroNav">
						<?php 
							...
							if($video && !in_array($status, ['SOLD', 'RESERVED']))
							...
							if(get_field( 'plantegninger' ) && !in_array($status, ['SOLD', 'RESERVED']))
							...
							if(!in_array($status, ['SOLD', 'RESERVED']) && !get_field( 'pris_pa_foresporgsel'))
